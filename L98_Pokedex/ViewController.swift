...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        searchBar.returnKeyType = UIReturnKeyType.Done // 'done' replacing enter on keyboard
    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        if searchBar.text == nil || searchBar.text == "" {
            ...
            // $0 addresses each and every value of an array
            // every item is checked to contain whatever letters have been entered into the textfield
